  ...
  <div class="resume-body">
    ...
    <div class="personal-info">
      ...
      <div class="contact-row">
        ...
        <span class="contact-chip" id="age"><svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" style="vertical-align:middle"><path d="M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm1 12h-2v-6h-2v-2h4v8z"/></svg> 年龄：<span class="val"></span></span>
